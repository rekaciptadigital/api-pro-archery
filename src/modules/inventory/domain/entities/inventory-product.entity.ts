...
export class InventoryProduct extends BaseEntity {
  ...
  @OneToMany(() => InventoryProductCategory, category => category.inventory_product, {
    cascade: true
  })
  categories: InventoryProductCategory[];

  @OneToMany(() => InventoryProductSelectedVariant, variant => variant.inventory_product, {
    cascade: true
  })
  variants: InventoryProductSelectedVariant[];

  @OneToMany(() => InventoryProductByVariant, productVariant => productVariant.inventory_product, {
    cascade: true
  })
