...
export class InventoryProductController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all inventory products with pagination and search' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Return all inventory products' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Return inventory product by id' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Inventory product not found' })
